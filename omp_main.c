...
int main(int argc, char **argv) {
    ...
    extern int     optind;
           ...
           float   threshold;
           double  timing, io_timing, clustering_timing, timer;
    ...
    timer = omp_kmeans(is_perform_atomic, objects, numCoords, numObjs, numClusters, threshold, membership, clusters);
    ...
    if (is_output_timing) {
        io_timing = omp_get_wtime() - io_timing - timer;
